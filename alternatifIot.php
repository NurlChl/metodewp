...
foreach ($dataIot as $iot) {
    $normalIot = $iot["normalisasi"];
    array_push($arrayIot, $normalIot);
}
...
<body>
    ...
    <section>
        <div>
            <h1>Alternatif Mahasiswa Layak IOT</h1>
        </div>
        <table>
            <tr>
                <th>Nama</th>
            ...
            ?>
            <tr>
                <td><?= $dataIot[$i]["nama"]; ?></td>
                <td><?= $dataIot[$i]["eldig"]; ?></td>
                <td><?= $dataIot[$i]["siskom"]; ?></td>
                <td><?= $dataIot[$i]["robotic"]; ?></td>
                <td><?= $dataIot[$i]["minat"]; ?></td>
