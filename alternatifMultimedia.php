...
// $multimedia = query("SELECT * FROM multimedia ORDER BY minat DESC");
...
<body>
    ...
    <section>
        <div>
            <h1>Alternatif Mahasiswa Layak Multimedia</h1>
        </div>
        <table>
            <tr>
                <th>Nama</th>
            ...
            <?php 
                for ($i=0; $i<$longData; $i++) {
                    // rsort($arrayMultimedia);
                    $v = ($arrayMultimedia[$i])/$jumlahNilai;
            ?>
            <tr>
                <td><?= $multimedia[$i]["nama"]; ?></td>
                <td><?= $multimedia[$i]["grafkom"]; ?></td>
                <td><?= $multimedia[$i]["unity"]; ?></td>
                <td><?= $multimedia[$i]["pbo"]; ?></td>
                <td><?= $multimedia[$i]["minat"]; ?></td>
